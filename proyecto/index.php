...
$buscar = $_POST['txtbuscar'];
 ...
 where pro.cat=cate.catcod and cod = '".$buscar."'");
...
else
{
 ...
 where pro.cat=cate.catcod ORDER BY pro.cod ASC LIMIT " . (($pagina - 1) * $filasmax)  . "," . $filasmax);
    ...
    ?>
    <table><tr>
	<th colspan="6"><h1>Materiales de Construccion</h1></th></tr>
	<tr>
	<th><a href="index.php">Inicio</a></th>
	<form method="POST">
	<th colspan="4">
	<input type="submit" value="&#128270; Buscar" name="btnbuscar">
	<input type="text" name="txtbuscar" id="cajabuscar" placeholder="Ingresar codigo a buscar" autocomplete="off"></th>
	</form>
	<th>
